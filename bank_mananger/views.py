...
from consultant.models import Customer,Account,Card
...
def manage_users(request):
    users = User.objects.all()
    return render(request,"admin/manage/manage_users.html",{
        'users':users,
    })
@login_required()
...
def add_consultant(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, 'You have successfully created a consultant.')
            return redirect('admin-manage-consultants')
    
        else:
            messages.error(request, 'Failed to create consultant.')
            return redirect('admin-add-consultant')
    else:
        form = ConsultantForm()
        return render(request,"admin/forms/add_consultant.html",{
            'form':form,
        })
@login_required()  
def update_consultant(request,id):
    if request.method=='POST':
        consultant = Consultant.objects.get(pk=id)
        form = ConsultantForm(request.POST,instance=consultant)
        if form.is_valid():
            consultant = form.save()
            messages.success(request, "You have successfully updated the consultant's details.")
            return redirect('admin-manage-consultants')
        else:
            messages.error(request, "Failed to update consultant details.")
            return redirect('admin-update-consultant',id)
    else:
        consultant = Consultant.objects.get(pk=id)
        form = ConsultantForm(instance=consultant)
        return render(request,"admin/forms/update_consultant.html",{
            'form':form,
...
def manage_consultants(request):
    consultants = Consultant.objects.all()
    return render(request,"admin/manage/manage_consultants.html",{
...
def delete_consultant(request,id):
    consultant = Consultant.objects.get(pk=id)
    consultant.delete()
    messages.success(request, 'Consultant successfully deleted.')
    return redirect('admin-manage-consultants')
@login_required()
def add_client(request):
    ...
    if request.method=='POST':
        ...
        form = ClientForm()
        return render(request,"admin/forms/add_client.html",{
            'form':form,
        })
@login_required()  
def update_client(request,id):
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return redirect('admin-update-client',id)
    else:
        client = Customer.objects.get(pk=id)
        form = ClientForm(instance=client)
        return render(request,"admin/forms/update_client.html",{
            'form':form,
            'client':client,
        })
@login_required()
def manage_clients(request):
    clients = Customer.objects.all()
    return render(request,"admin/manage/manage_clients.html",{
        'clients':clients,
    })
@login_required()
...
def add_account(request):
    if request.method == 'POST':
        ...
        form = AccountForm()
        return render(request,"admin/forms/add_account.html",{
            'form':form,
        })
@login_required() 
def update_account(request,id):
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return redirect('admin-update-account',id)
    else:
        account = Account.objects.get(pk=id)
        form = AccountForm(instance=account)
        return render(request,"admin/forms/update_account.html",{
            'form':form,
            'account':account,
        })
@login_required()
def manage_accounts(request):
    accounts = Account.objects.all()
    return render(request,"admin/manage/manage_accounts.html",{
        'accounts':accounts,
    })
@login_required()
...
def add_card(request):
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return redirect('admin-manage-cards')
        else:
            messages.error(request, "Failed to create client's card.")
            return redirect('admin-add-card')
    else:
        form = CardForm()
        return render(request,"admin/forms/add_card.html",{
            'form':form,
        })
@login_required()   
def update_card(request,id):
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return redirect('admin-update-card',id)
    else:
        card = Card.objects.get(pk=id)
        form = CardForm(instance=card)
        return render(request,"admin/forms/update_card.html",{
            'form':form,
            'card':card,
        })
@login_required()
def manage_cards(request):
    cards = Card.objects.all()
    return render(request,"admin/manage/manage_cards.html",{
        'cards':cards,
    })
@login_required()
...
@login_required()
def admin_client_transactions_view(request,id):
    account = Account.objects.get(pk=id)
...
def update_admin_profile(request,id):
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return redirect('update_admin_profile',id)
    else:
        user = User.objects.get(pk=id)
        form = UpdateUserForm(instance=user)
        return render(request,"admin/forms/update_user.html",{
            'form':form,
            'user':user,
