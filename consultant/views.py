...
def manage_users(request):
    users = User.objects.all()
    return render(request,"consultant/manage/manage_users.html",{
        'users':users,
    })
@login_required()
...
def add_consultant(request):
    ...
    if request.method=='POST':
        ...
        form = ConsultantForm()
        return render(request,"consultant/forms/add_consultant.html",{
            'form':form,
        })
@login_required()  
def update_consultant(request,id):
    if request.method=='POST':
        ...
        return render(request,"consultant/forms/update_consultant.html",{
            'form':form,
...
def manage_consultants(request):
    consultants = Consultant.objects.all()
    return render(request,"consultant/manage/manage_consultants.html",{
